  ...
  MAP: <Popup document='priloha3' page={3} title='Jak identifikovat oblasti pro rozvoj školy?'>
    <div>
      <p>
        ...
        Školám pomohou v identifikaci jejich potřeb výsledky a vyhodnocení Výstupu z dotazníkového šetření MAP, které budou školám zaslány ze strany MŠMT a zpřístupněny ve webovém rozhraní https://sberdat.uiv.cz/login.
      ...
      <p>
        ...
        Pro tuto oblast nejsou v 1.vlně šablon připraveny žádné šablony.
