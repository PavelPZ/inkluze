...
var Kurzy: React.StatelessComponent<IKurzyPars> = (props: IKurzyPars, ctx: sitemapRouter.IContext) => {
  var kurz = props ? parseInt(props.kurz.toString()) : kurzEnum.no;
  debugger;
  return <div>
    <Page>
      <Block>
