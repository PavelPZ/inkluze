  ...
  <Page>
    ...
    <BlockEx>
      <ul className='fa-ul'>
        ...
        <LiHand><h4><b>12. 4. 2021 Různé metody pro začlenění ICT technologií do výuky</b></h4>
          <h4><Label bsStyle="warning">ICT</Label></h4>
        ...
        <LiHand><h4><b>26. 4. 2021 Inspirace pro využití interaktivních tabulí při výuce  </b></h4>
          <h4><Label bsStyle="warning">ICT</Label></h4>
